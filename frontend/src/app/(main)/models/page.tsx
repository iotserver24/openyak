...
import { ArrowLeft, Eye, EyeOff, X, Check, Loader2, AlertCircle, LogOut, CreditCard, Mail, RotateCw, Cpu } from "lucide-react";
    ...
    <div className="flex-1 overflow-y-auto">
      <div className="mx-auto max-w-2xl px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-lg font-semibold text-[var(--text-primary)]">{t('modelAccess')}</h1>
        </div>
              ...
              {authStore.isConnected && authStore.user ? (
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" asChild><Link href="/billing"><CreditCard className="h-3.5 w-3.5 mr-1.5" />{t('buyCredits')}</Link></Button>
